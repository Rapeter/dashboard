...
export function ConsentFormContent({ onValidityChange }: ConsentFormContentProps) {
      ...
      <section className="border border-gray-200 rounded-md p-5 bg-white text-sm text-gray-700">
        ...
        <ul className="list-disc pl-6 space-y-2 leading-6">
          ...
          <li>
            ...
            Australian hazelnut production and develop a real-time management platform for industry
            data.
          </li>
          ...
          <li>
            ...
            provide details about my hazelnut farm, orchard, or factory, covering production,
